...
“IBM Bob built the trust-critical foundation. Granite adds a bounded IBM runtime explanation layer. Agent Receipt gives the accountable human the final decision, based only on the supplied trace and authority envelope.”
